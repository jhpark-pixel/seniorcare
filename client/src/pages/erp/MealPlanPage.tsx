...
const weeklyMeals: DayMeal[] = [
  {
    day: '월요일',
    breakfast: '흰죽, 계란찜, 깍두기, 배추김치, 우유',
    lunch: '보리밥, 된장찌개, 제육볶음, 시금치나물, 배추김치',
    dinner: '흰밥, 미역국, 고등어구이, 콩나물무침, 깍두기',
    calories: 1650,
  },
  {
    day: '화요일',
    breakfast: '잡곡밥, 북어국, 두부조림, 열무김치, 요구르트',
    lunch: '흰밥, 김치찌개, 불고기, 도라지무침, 깍두기',
    dinner: '흰밥, 콩나물국, 생선까스, 오이소박이, 배추김치',
    calories: 1720,
  },
  {
    day: '수요일',
    breakfast: '누룽지죽, 감자조림, 멸치볶음, 배추김치, 바나나',
    lunch: '비빔밥, 계란국, 잡채, 깻잎장아찌, 깍두기',
    dinner: '흰밥, 소고기무국, 두부구이, 숙주나물, 배추김치',
    calories: 1580,
  },
  {
    day: '목요일',
    breakfast: '잡곡밥, 시래기국, 어묵볶음, 총각김치, 우유',
    lunch: '흰밥, 순두부찌개, 닭갈비, 미나리무침, 깍두기',
    dinner: '흰밥, 떡국, 동태전, 고사리나물, 배추김치',
    calories: 1690,
  },
  {
    day: '금요일',
    breakfast: '흰죽, 호박전, 장조림, 배추김치, 사과',
    lunch: '카레라이스, 달걀파국, 치킨너겟, 양배추샐러드, 깍두기',
    dinner: '흰밥, 오징어무국, 갈치구이, 무생채, 배추김치',
    calories: 1640,
  },
  {
    day: '토요일',
    breakfast: '잡곡밥, 감자국, 김구이, 젓갈, 요구르트',
    lunch: '흰밥, 부대찌개, 잔치국수, 단무지, 깍두기',
    dinner: '흰밥, 아욱국, 삼치구이, 깻잎절임, 배추김치',
    calories: 1610,
  },
  {
    day: '일요일',
    breakfast: '야채죽, 계란말이, 김치전, 배추김치, 우유',
    lunch: '흰밥, 갈비탕, 잡채, 오이무침, 깍두기',
    dinner: '흰밥, 배추국, 제육볶음, 도토리묵무침, 배추김치',
    calories: 1700,
  },
];
    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 text-center">
          ...
          <p className="text-2xl font-bold text-gray-900">{Math.round(weeklyMeals.reduce((s, m) => s + m.calories, 0) / 7)} kcal</p>
        </div>
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 text-center">
